...
public class MotivasiKristen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_motivasi_kristen);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(MotivasiKristen.this));
        ...
        userAdapterKristen= new UserAdapterKristen(MotivasiKristen.this,modelSementaraList);
